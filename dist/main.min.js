var App = function() {
    var a = {
        ...
        moment.tz.setDefault("Europe/Paris"), $('[data-toggle="tooltip"]').tooltip(), b.lines = $("#form-select-lines"), 
        b.bookmarks = $("#form-bookmarks"), b.directionsToggle = $("#form-direction-toggle"), 
        b.direction1 = $("#form-direction-1"), b.direction2 = $("#form-direction-2"), b.stations = $("#form-select-stations"), 
        b.timetable = $("#form-table-timetable"), b.addStar = $("#form-star-add"), b.removeStar = $("#form-star-remove"), 
        Bookmarks.init(), e(), g(), h();
    }, e = function() {
        for (var d = 0; d < a.lines.length; d++) {
            var e = a.lines[d];
            b.lines.append(HtmlGenerator.createLineOptionElement(e, d));
        }
        c.line = a.lines[0], i(c.line);
    }, f = function() {
        b.stations.html("");
        var a, d;
        ...
        a.forEach(function(a) {
            null !== a && b.bookmarks.append(HtmlGenerator.createBookmarkElement(a));
        });
    }, h = function() {
        b.lines.on("change", function(b) {
            var d = $(this).val();
            c.line = a.lines[d], i(c.line);
        }), b.stations.on("change", function(a) {
            var d = $(this).val();
            c.station = c.line.stations[d], j(c.station), n(b.directionsToggle.parent().prev());
        }), b.directionsToggle.on("click", function(a) {
            k();
        }), b.addStar.on("click", function() {
            Bookmarks.set(c.line.key, c.station.key), b.removeStar.removeClass("hidden"), b.addStar.addClass("hidden");
        }), b.removeStar.on("click", function() {
            Bookmarks.remove(c.line.key, c.station.key), b.addStar.removeClass("hidden"), b.removeStar.addClass("hidden");
        }), b.bookmarks.find("li").on("click", function() {
            var a = $(this);
            l(a);
        });
    }, i = function(a) {
        ...
        b.timetable.append('<tr><td colspan="2"><p class="text-center">Load the <a class="form-load-full-timetable">full timetable</a>.</p></td></tr>'), 
        $(".form-load-full-timetable").on("click tab", function() {
            b.timetable.find("tr").removeClass("hidden"), $(this).parent().parent().remove(), 
            n(b.timetable.prev());
        }));
        var g = Bookmarks.get(c.line.key, c.station.key);
        g ? (b.addStar.addClass("hidden"), b.removeStar.removeClass("hidden")) : (b.addStar.removeClass("hidden"), 
        b.removeStar.addClass("hidden"));
    }, k = function() {
        ...
        b.stations.val(h), j(c.station);
    }, l = function(d) {
        var e = d.attr("data-line"), f = d.attr("data-station");
        c.line = a.lines[e], b.lines.val(e), c.station = c.line[f], i(c.line), b.stations.val(f), 
        j(c.station);
    }, m = function() {
...
var HtmlGenerator = function() {
    var a = function(a, b) {
        ...
        var b = $("<li></li>");
        return b.append('<span class="fa fa-2x fa-home"></span>'), b.attr("data-line", a.line), 
